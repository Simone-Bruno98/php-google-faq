...
<head>
    ...
    <script src="https://kit.fontawesome.com/6047898c5f.js" crossorigin="anonymous"></script>
</head>
<body>
    <?php
            $faqArr = [
    ...
    <header>
        <div class="headercontainer">
            <div class="row logoandprofile justify-content-between">
                <div class="col-2">
                    <img src="img/google-logo-9831.png" alt="">
                    <span class="privacy">Privacy e termini</span>
                </div>
                <div class="col-1 headerright">
                    <i class="fa-solid fa-grip-dots"></i>
                    <span class="profileimage">S</span>
                </div>
            </div>
            <div class="row nav">
                <div class="col-6">
    ...
    <main>
        <div class="container py-5">
            <?php
            foreach ($faqArr as $value) {
                echo "<div>";
                foreach ($value as $key => $testo) {
                    if ($key == 'domanda') {
                        echo '<h5 class="maintext domanda">'.$testo.'</h5>';
                    }else{
                        echo '<p class="maintext risposta">'.$testo.'</p>';
                    }
                }
                echo "</div>";
            }
